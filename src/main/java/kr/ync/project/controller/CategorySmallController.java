...
import kr.ync.project.service.CategorySmallService;
...
public class CategorySmallController {
	...
	*//**
	 ...
	 * public String categorybigRegister(Locale locale, Model model) throws
	 * Exception{
	 * 
	 * logger.info("카테고리 등록");
	 * 
	 * List category = null; category = (List) service.insert(categorybigVO);
	 * 
	 * //틀만 잡힘.
	 * 
	 * model.addAttribute("category",JSONArray.fromObject(categorybigVO)); return
	 * "admin/categorybigRegister"; }
	 ...
	 * @GetMapping(value = "/categorybigRegister") public void registGET() throws
	 * Exception {
	 * 
	 * logger.info("regist get ..........."); }
	 
	
	 * @PostMapping(value = "/categorybigRegister") public String
	 * registPOST(CategoryBigVO categorybigVO, RedirectAttributes rttr) throws
	 * Exception {
	 * 
