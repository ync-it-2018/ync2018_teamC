							...
							<ul class="dropdown-menu">
								...
								<li class="user-footer">
									...
									<div class="pull-right">
										<a href="/admin/alogout" class="btn btn-default btn-flat">log
											out</a>
									</div>
								</li>
							</ul></li>
			...
			<section class="sidebar">
				...
				<ul class="sidebar-menu">
					...
					<li class="treeview"><a href="#"> <i
							class="fa fa-dashboard"></i> <span>관리자 로그인</span> <i
							class="fa fa-angle-left pull-right"></i>
					</a>

						<ul class="treeview-menu">
							<li><a href="/admin/alogin"><i class="fa fa-circle-o"></i>
									로그인</a></li>
					...
					<li class="treeview"><a href="#"> <i
							class="fa fa-pie-chart"></i> <span>쇼핑 관리</span> <i
							class="fa fa-angle-left pull-right"></i>
					</a>
						<ul class="treeview-menu">
							...
							<li><a href="/admin/productup"><i class="fa fa-circle-o"></i>
									상품등록</a></li>
							<li><a href="/admin/productlist"><i
									class="fa fa-circle-o"></i> 상품관리</a></li>
						</ul></li>
					<li class="treeview"><a href="#"> <i class="fa fa-laptop"></i>
							<span>회원관리</span> <i class="fa fa-angle-left pull-right"></i>
					</a>
						<ul class="treeview-menu">
							<li><a href="/admin/memberlist"><i
					...
					<li class="treeview"><a href="#"> <i class="fa fa-files-o"></i>
							<span>이벤트</span> <i class="fa fa-angle-left pull-right"></i>
					</a>
						<ul class="treeview-menu">
							<li><a href="/aevent"><i class="fa fa-circle-o"></i> 이벤트
									등록 </a></li>
							<li><a href="/admin/aeventList"><i
									class="fa fa-circle-o"></i> 이벤트 리스트 </a></li>
							<li><a href="/aeventPhoto"><i class="fa fa-circle-o"></i>
									이벤트 사진 관리 </a></li>
						</ul></li>

					<li class="treeview"><a href="#"> <i class="fa fa-table"></i>
							<span>매출관리</span> <i class="fa fa-angle-left pull-right"></i>
					</a>
						<ul class="treeview-menu">
							<li><a href="/adaysaleprice"><i class="fa fa-circle-o"></i>
									일별매출</a></li>
							<li><a href="/asaleprice"><i class="fa fa-circle-o"></i>
									매출조회</a></li>
						</ul></li>
					<li><a href="../calendar.html"> <i class="fa fa-calendar"></i>
							<span>문의관리</span> <i class="fa fa-angle-left pull-right"></i>
					</a>
						<ul class="treeview-menu">
							<li><a href="/Qnalist"><i class="fa fa-circle-o"></i>
									문의관리 목록</a></li>
						</ul></li>
