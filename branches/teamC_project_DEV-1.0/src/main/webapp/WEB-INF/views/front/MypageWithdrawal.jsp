...
<body class="animsition">
	...
	<header class="header-v4">
			...
			<div class="top-bar">
				<div class="content-topbar flex-sb-m h-full container">
					...
					<div class="right-top-bar flex-w h-full">
						<a href="/login" class="flex-c-m trans-04 p-lr-25"> LOGIN </a> <a
							href="/join" class="flex-c-m trans-04 p-lr-25"> JOIN </a> <a
							href="#" class="flex-c-m trans-04 p-lr-25"> MyPage </a>
			...
			<div class="wrap-menu-desktop">
				<nav class="limiter-menu-desktop container">
					...
					<a href="/index" class="logo"> <img
						src="/resources/front/images/icons/logo-01.png" alt="IMG-LOGO">
					</a>

					<!-- Menu desktop -->
					<div class="menu-desktop">
						<ul class="main-menu">
							<li class="active-menu"><a href="/index">Home</a></li>
		...
		<div class="wrap-header-mobile">
			...
			<div class="logo-mobile">
				<a href="/index"><img
					src="/resources/front/images/icons/logo-01.png" alt="IMG-LOGO"></a>
			</div>
		...
		<div class="menu-mobile">
			...
			<ul class="main-menu-m">
				...
				<li><a href="/shoping-cart" class="label1 rs1"
		...
		<div
			...
			<div class="container-search-header">
				<button
					...
					<img src="/resources/front/images/icons/icon-close2.png"
						alt="CLOSE">
				</button>
	...
	<div class="bg0 m-t-23 p-b-140">
		<div class="container">
			...
			<hr>
			<label for="passward" style="padding: left;"><b>비밀번호</b></label> <input
				style="width: 130px; border: 1px solid lightgray; padding: right;"
				type="password" name="passward"> <br> <label for=""
				style="padding: left;"><b>불편했던 점</b></label>
			<!-- <textarea
				style="width: 700px; height: 200px; "
				type="textbox" name=""> -->
  		    <textarea rows="6" cols="70" style="border: 1px solid lightgray;"></textarea>
  		    <br>
  		    <hr>
			<button type="button" style="border:1px solid black; background-color: white; padding: 14px 20px;
    		margin: 8px 0;  border-radius: 15px; margin: 8px 0; width: 100px; opacity: 0.9; float:right">탈퇴</button>
		</div>
	</div>
			...
			<div class="p-t-40">
				<div class="flex-c-m flex-w p-b-18">
					<a href="#" class="m-all-1"> <img
						src="/resources/front/images/icons/icon-pay-01.png" alt="ICON-PAY">
					</a> <a href="#" class="m-all-1"> <img
						src="/resources/front/images/icons/icon-pay-02.png" alt="ICON-PAY">
					</a> <a href="#" class="m-all-1"> <img
						src="/resources/front/images/icons/icon-pay-03.png" alt="ICON-PAY">
					</a> <a href="#" class="m-all-1"> <img
						src="/resources/front/images/icons/icon-pay-04.png" alt="ICON-PAY">
					</a> <a href="#" class="m-all-1"> <img
						src="/resources/front/images/icons/icon-pay-05.png" alt="ICON-PAY">
					</a>
				</div>
