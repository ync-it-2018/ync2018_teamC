...
<body class="animsition">
	...
	<header class="header-v2">
		...
		<div class="wrap-header-mobile">
			...
			<div class="logo-mobile">
				<a href="index.html"><img src="/resources/front/images/icons/logo-01.png" alt="IMG-LOGO"></a>
			</div>
				...
				<div class="sidebar-gallery w-full p-tb-30">
					...
					<div class="flex-w flex-sb p-t-36 gallery-lb">
						...
						<div class="wrap-item-gallery m-b-10">
							<a class="item-gallery bg-img1" href="/resources/front/images/gallery-01.jpg" data-lightbox="gallery" 
							style="background-image: url('/resources/front/images/gallery-01.jpg');"></a>
						</div>

						<!-- item gallery sidebar -->
						<div class="wrap-item-gallery m-b-10">
							<a class="item-gallery bg-img1" href="/resources/front/images/gallery-02.jpg" data-lightbox="gallery" 
							style="background-image: url('/resources/front/images/gallery-02.jpg');"></a>
						</div>

						<!-- item gallery sidebar -->
						<div class="wrap-item-gallery m-b-10">
							<a class="item-gallery bg-img1" href="/resources/front/images/gallery-03.jpg" data-lightbox="gallery" 
							style="background-image: url('/resources/front/images/gallery-03.jpg');"></a>
						</div>

						<!-- item gallery sidebar -->
						<div class="wrap-item-gallery m-b-10">
							<a class="item-gallery bg-img1" href="/resources/front/images/gallery-04.jpg" data-lightbox="gallery" 
							style="background-image: url('/resources/front/images/gallery-04.jpg');"></a>
						</div>

						<!-- item gallery sidebar -->
						<div class="wrap-item-gallery m-b-10">
							<a class="item-gallery bg-img1" href="/resources/front/images/gallery-05.jpg" data-lightbox="gallery" 
							style="background-image: url('/resources/front/images/gallery-05.jpg');"></a>
						</div>

						<!-- item gallery sidebar -->
						<div class="wrap-item-gallery m-b-10">
							<a class="item-gallery bg-img1" href="/resources/front/images/gallery-06.jpg" data-lightbox="gallery" 
							style="background-image: url('/resources/front/images/gallery-06.jpg');"></a>
						</div>

						<!-- item gallery sidebar -->
						<div class="wrap-item-gallery m-b-10">
							<a class="item-gallery bg-img1" href="/resources/front/images/gallery-07.jpg" data-lightbox="gallery" 
							style="background-image: url('/resources/front/images/gallery-07.jpg');"></a>
						</div>

						<!-- item gallery sidebar -->
						<div class="wrap-item-gallery m-b-10">
							<a class="item-gallery bg-img1" href="/resources/front/images/gallery-08.jpg" data-lightbox="gallery" 
							style="background-image: url('/resources/front/images/gallery-08.jpg');"></a>
						</div>

						<!-- item gallery sidebar -->
						<div class="wrap-item-gallery m-b-10">
							<a class="item-gallery bg-img1" href="/resources/front/images/gallery-09.jpg" data-lightbox="gallery" 
							style="background-image: url('/resources/front/images/gallery-09.jpg');"></a>
						</div>
					</div>
				</div>
	...
	<section class="section-slide">
		<div class="wrap-slick1 rs1-slick1">
			<div class="slick1">
				<div class="item-slick1" style="background-image: url(/resources/front/images/slide-03.jpg);">
				...
				<div class="item-slick1" style="background-image: url(/resources/front/images/slide-02.jpg);">
					<div class="container h-full">
						<div class="flex-col-l-m h-full p-t-100 p-b-30">
				...
				<div class="item-slick1" style="background-image: url(/resources/front/images/slide-04.jpg);">
					<div class="container h-full">
						<div class="flex-col-l-m h-full p-t-100 p-b-30">
		...
		<div class="flex-w flex-c-m">
			<div class="size-202 m-lr-auto respon4">
				...
				<div class="block1 wrap-pic-w">
					<img src="/resources/front/images/banner-04.jpg" alt="IMG-BANNER">
			...
			<div class="size-202 m-lr-auto respon4">
				<!-- Block1 -->
				<div class="block1 wrap-pic-w">
					<img src="/resources/front/images/banner-05.jpg" alt="IMG-BANNER">
			...
			<div class="size-202 m-lr-auto respon4">
				<!-- Block1 -->
				<div class="block1 wrap-pic-w">
					<img src="/resources/front/images/banner-06.jpg" alt="IMG-BANNER">
			...
			<div class="row">
					...
					<div class="blog-item">
						<div class="hov-img0">
							<a href="blog-detail.html">
								<img src="/resources/front/images/blog-01.jpg" alt="IMG-BLOG">
							</a>
						</div>
				...
				<div class="col-sm-6 col-md-4 p-b-40">
					<div class="blog-item">
						<div class="hov-img0">
							<a href="blog-detail.html">
								<img src="/resources/front/images/blog-02.jpg" alt="IMG-BLOG">
							</a>
						</div>
				...
				<div class="col-sm-6 col-md-4 p-b-40">
					<div class="blog-item">
						<div class="hov-img0">
							<a href="blog-detail.html">
								<img src="/resources/front/images/blog-03.jpg" alt="IMG-BLOG">
							</a>
						</div>
		...
		<div class="container">
			<div class="bg0 p-t-60 p-b-30 p-lr-15-lg how-pos3-parent">
				<button class="how-pos3 hov3 trans-04 js-hide-modal1">
					<img src="/resources/front/images/icons/icon-close.png" alt="CLOSE">
				</button>
								...
								<div class="slick3 gallery-lb">
									<div class="item-slick3" data-thumb="images/product-detail-01.jpg">
										<div class="wrap-pic-w pos-relative">
											<img src="/resources/front/images/product-detail-01.jpg" alt="IMG-PRODUCT">
