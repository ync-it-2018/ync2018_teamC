				...
				<div class="box-body">
					<div class="form-group">
						<label for="exampleInputEmail1">대분류 카테고리 번호</label> <input
							type="text" name='pBig' class="form-control"
							value="${categoryBigVO.pBig}" readonly="readonly">
					</div>
					<div class="form-group">
						<label for="exampleInputEmail1">대분류 카테고리 명</label> <input
							type="text" name='pBigName' class="form-control"
							value="${categoryBigVO.pBigName}" readonly="readonly">
					</div>
				</div>
