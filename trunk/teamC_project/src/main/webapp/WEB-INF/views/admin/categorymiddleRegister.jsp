			...
			<div class="col-md-12">
				...
				<div class="box box-primary">
					<div class="box-header">
						<h3 class="box-title">REGISTER Middle Category</h3>
					</div>
					<!-- /.box-header -->
					...
					<form role="form" method="post">
						<div class="box-body">
							...
							<div class="form-group">
								<label for="exampleInputEmail1">중분류 카테고리 명</label> <input
									type="text" id="pMiddleName" name='pMiddleName'
									class="form-control" placeholder="Enter pMiddleName">
							</div>
...
$(document).ready(function(){
	...
	$('.btn-warning').on("click", function() {
		...
		elf.location = "/admin/categorymiddleList";
